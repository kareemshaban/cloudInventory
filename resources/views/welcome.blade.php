...
*/
    ...
    <style>
        #frame-0 .hljs-ln-line[data-line-number='122'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-1 .hljs-ln-line[data-line-number='107'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-2 .hljs-ln-line[data-line-number='41'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-3 .hljs-ln-line[data-line-number='162'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-17 .hljs-ln-line[data-line-number='110'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-19 .hljs-ln-line[data-line-number='49'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-20 .hljs-ln-line[data-line-number='183'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-21 .hljs-ln-line[data-line-number='57'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-24 .hljs-ln-line[data-line-number='175'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
        ...
        #frame-26 .hljs-ln-line[data-line-number='1188'] {
            background-color: rgba(242, 95, 95, 0.4);
        }

        #frame-27 .hljs-ln-line[data-line-number='17'] {
            background-color: rgba(242, 95, 95, 0.4);
        }
    </style>
</head>
        ...
        <main class="px-6 pb-12 pt-6">
            <div class="container mx-auto">
                <section
                    ...
                    POST phn.d91.mytemp.website
                </span>
                            </div>
                            <div class="px-4">
                                <span class="text-sm text-gray-500 dark:text-gray-400">PHP 8.2.20 — Laravel 11.17.0</span>
                            </div>
                        </div>
                    </div>
                </section>
                        ...
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    ...
                                    <span class="font-mono text-xs">:122</span>
                                </span>
                            </div>
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">Illuminate\Routing\AbstractRouteCollection</span>
                                    <span class="font-mono text-xs">:41</span>
                                </span>
                            </div>
                            <div class="text-gray-500 dark:text-gray-400">
                                handleMatchedRoute
                ...
                >
                    ...
                    >
                        <div class="scrollbar-hidden overflow-x-auto border-l-2 border-transparent p-2">
                            <div class="nowrap text-gray-900 dark:text-gray-300">
                                <span class="inline-flex items-baseline">
                                    <span class="text-gray-900 dark:text-gray-300">Illuminate\Routing\RouteCollection</span>
                                    <span class="font-mono text-xs">:162</span>
                                </span>
                            </div>
                            <div class="text-gray-500 dark:text-gray-400">
                                match
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">vendor/laravel/framework/src/Illuminate/Routing/AbstractRouteCollection.php</span>
                                ...
                                <div class="mb-3">
                                    <div class="text-md text-gray-500 dark:text-gray-400">
                                        <div class="mb-2">
                                            ...
                                            <span class="wrap text-gray-900 dark:text-gray-300">vendor/laravel/framework/src/Illuminate/Routing/RouteCollection.php</span>
...
(require_once __DIR__.&#039;/bootstrap/app.php&#039;)
    -&gt;handleRequest(Request::capture());
                ...
                >
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">1312</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <span
                ...
                >
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">phn.d91.mytemp.website</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <span
                ...
                >
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">PostmanRuntime/7.40.0</code></pre>
                </span>
                        </div>
                        <div class="flex items-center gap-2 border-t dark:border-gray-800">
                            <span
                ...
                >
                    ...
                    "
                >
                    <pre class="scrollbar-hidden overflow-y-hidden text-xs lg:text-sm"><code class="px-5 py-3 overflow-y-hidden scrollbar-hidden max-h-32 overflow-x-scroll scrollbar-hidden-x">236a366a-e525-40d4-a5ad-b4c0843c2f0c</code></pre>
                </span>
                        </div>
                    </dl>
